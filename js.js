let wpp = `[Type("Name")
{
Lebanon("dont call 911" + "2" + "3")
Lolz("1" + "3" + "5" + "6")
}]`;

let wpp2 = `[Type("Name") { Lebanon("1" + "2" + "3"), Lolz("1" + "3" + "5" + "6") }]`;
 ...
 */
 function parseWpp() {
    ...
    let splitted = oneLineFormat === false ? input.split("\n") : input.split(",");
    ...
    for (const el of splitted) {
      ...
      let valuesRaw = trimmedEl.substring(valuesStartIndex + 1, valuesEndIndex);
      let values = [];
      let currentIndex = 0;
